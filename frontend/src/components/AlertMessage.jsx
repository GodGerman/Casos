...
// Iconos inline para distintos tipos de alerta.
// Mantenerlos aqui evita dependencias externas y facilita el theming.
const ICONS = {
...
/**
 * Muestra un mensaje de alerta con icono y estilo segun tipo.
 *
 * Se mapea el tipo a un icono y clase Bootstrap y
 * retorna null cuando no hay mensaje para no ocupar espacio.
 *
 *
...
export default function AlertMessage({ type = 'info', message, toast}) {
  ...
  // Asigna clase Bootstrap segun tipo de alerta.
  const alertClass = type === 'danger' ? 'alert-danger' :
    type === 'success' ? 'alert-success' :
      type === 'warning' ? 'alert-warning' : 'alert-info';

  const toastClass = toast ? 'alert-toast' : '';
